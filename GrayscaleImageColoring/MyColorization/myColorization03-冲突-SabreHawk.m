...
resizeScale = 0.1;
DesGreyImage = imread('desImage02.jpg');
...
SouColorImage = imread('colorImage02.jpg');
...
colorizedImageMatrix = PixelNodeColorization(desPixelMatrix,desSegLabelMax,desMatchLabelMatrix,souPixelMatrix,labDesGreyImage);
